...
exports.createUser = async (req, res) => {
    ...
    try {
        ...
        const {  email, password,role} = userData //Destructuring data
...
exports.userLogin = async (req, res) => {
    try {
        ...
        let token = jwt.sign({ userId: validUser._id }, 'recovero', { expiresIn: '6d' }); //generate jwt token at succesfull login 
